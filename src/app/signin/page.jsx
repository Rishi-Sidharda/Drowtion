...
export default function Signin() {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className={`flex flex-1 flex-col justify-center items-center px-4 py-10 lg:px-6 ${geistMono.variable} font-mono`}>
        ...
        <div className="w-full max-w-xl bg-white rounded-2xl shadow-lg border p-10" >
          ...
          <form onSubmit={() => {alert("Submitted")}} method="post" className="mt-6 space-y-4">
            <div>
              <Label
